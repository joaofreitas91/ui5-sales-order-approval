		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comlab2devsalesorderapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devsalesorderapproval-display": {
								"semanticObject": "comlab2devsalesorderapproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.salesorderapproval",
									"url": sap.ui.require.toUrl("com/lab2dev/salesorderapproval")
								}
							}
						}
					}
